    ...
    >
      ...
      <div className="text-center leading-10 lg:text-left">
        ...
        <p className="leading-7 mt-5 mb-9 max-w-[500px]">
          ...
          passionné de nouvelles technologies, avec un sens aigue du design et
          de l'observation. Je serais ravi de travailler avec vous pour créer de
        ...
        <div className="flex flex-col items-center md:flex-row gap-8">
          ...
          <div className="mb-8 md:mb-0">
            <Socials
              ...
              iconStyles="w-9 h-9 border border-[#1C6961] rounded-full flex items-center justify-center text-[#0EB39E] hover:bg-[#0EB39E] hover:text-[#FFFFFF] hover:transition-all duration-300"
            />
          </div>
        </div>
      </div>
