  ...
  return (
    <>
      <div className="container mx-auto text-white">
        <div className="flex items-center justify-between flex-col mb-10 lg:flex-row pt-10 lg:pt-8 lg:pb-12">
          {/* bio */}
          <div className="text-center leading-10 lg:text-left">
            ...
            <p className="leading-7 mt-5 mb-9 max-w-[500px]">
              ...
              passioné de nouvelles technologies, avec un sens aigue du design
              et de l'observation. Je serais ravi de travailler avec vous pour
              créer de nouvelles choses. Alors, contactez-moi !
            </p>
